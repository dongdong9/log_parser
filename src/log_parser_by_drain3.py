...
class LogParserByDrain3:
    ...
    def parse_log_file(self, raw_log_csv_path, result_file_path):
        ...
        analysis_result_df = pd.DataFrame(analysis_result_list,
                                          columns=["_time", "content",
                                                   ...
                                                   "EventId", "EventTemplate", "star_ratio", "Occurrences",
                                                   "ParameterList"])
    ...
    def compare_predict_with_gold(self, predict_file_path, gold_file_path, compare_result_file_path):
        ...
        for row_index in range(predict_item_count):
            ...
            [time_predict, content_predict, EventId_predict, EventTemplate_predict, Occurrences_predict,
             ParameterList_predict] = predict_line_detail
            [time_gold, content_gold, EventId_gold, EventTemplate_gold, Occurrences_gold,
             ParameterList_gold] = gold_line_detail
            ...
            is_parameter_same, intersection_set, only_in_predict_set, only_in_gold_set = get_tow_set_diff(
                set(ParameterList_predict), set(ParameterList_gold))
            compare_result_detail = [time_gold, content_gold, EventId_gold,
                                     EventTemplate_predict, EventTemplate_gold, is_template_same,
                                     Occurrences_gold,
                                     ParameterList_predict, ParameterList_gold, is_parameter_same, intersection_set,
                                     only_in_predict_set, only_in_gold_set]
        ...
        compare_result_df = pd.DataFrame(compare_result_list, columns=["_time", "content", "EventId",
                                                                       "EventTemplate_predict", "EventTemplate_gold",
                                                                       "is_template_same",
                                                                       "Occurrences_gold",
                                                                       "ParameterList_predict", "ParameterList_gold",
                                                                       "is_parameter_same", "intersection_set",
                                                                       "only_in_predict_set", "only_in_gold_set"])
